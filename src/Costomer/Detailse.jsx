        ...
        {cart ? (
          <div className=" max-w-sm w-full bg-white p-4 rounded shadow hover:shadow-lg transition flex flex-col justify-between">
            ...
            <div className="flex justify-around gap-5 mt-4">
              ...
              <Link to="/chatting" className="w-[150px] text-center text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5">
                Comment
              </Link>
            </div>
          </div>
